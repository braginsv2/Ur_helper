...
def export_clients_db_to_excel(db_path='clients.db', output_path='clients_export.xlsx'):
    ...
    column_mapping = {
        ...
        'Город': 'city',
        'Дата': 'date_ins',
        'Собственник': 'sobstvenik',
        'Эвакуатор': 'ev',
        'Клиент ФИО': 'fio',
        'Клиент ФИО короткое': 'fio_k',
        ...
        'Адрес проживания клиента': 'address',
        'Индекс клиента': 'index_postal',
        'Телефон клиента': 'number',
        'Дата рождения': 'date_of_birth',
        'Город Рождения клиента': 'city_birth',
        'Дата ДТП': 'date_dtp',
        'Время ДТП': 'time_dtp',
        'Адрес ДТП': 'address_dtp',
        'Кого вызывали на фиксацию дтп': 'who_dtp',
        'Марка, модель клиента': 'marks',
        'Номер авто клиента': 'car_number',
        'Год авто клиента': 'year_auto',
        'Документ о регистрации ТС': 'docs',
        'Серия документа РТС': 'seria_docs',
        'Номер документа РТС': 'number_docs',
        'Дата выдачи документа РТС': 'data_docs',
        'Страховая компания': 'insurance',
        'Серия страхового полиса': 'seria_insurance',
        'Номер страхового полиса': 'number_insurance',
        'Виновник ФИО Полностью': 'fio_culp',
        'Дата рождения виновника': 'date_of_birth_culp',
        'Марка, модель виновника': 'marks_culp',
        'Номер авто виновника': 'number_auto_culp',
        'Серия ВУ Виновника': 'seria_vu_culp',
        'Номер ВУ Виновника': 'number_vu_culp',
        'Дата ВУ Виновника': 'data_vu_culp',
        'Индекс Виновника': 'index_culp',
        'Адрес виновника': 'address_culp',
        'Телефон виновника': 'number_culp',
        'Банк получателя клиента': 'bank',
        'Счет получателя': 'bank_account',
        'Корреспондентский счет банка': 'bank_account_corr',
        'БИК банка': 'BIK',
        'ИНН банка': 'INN',
        'Собственник ФИО Полностью': 'fio_sobs',
        'Дата рождения собственника': 'date_of_birth_sobs',
        'Входящий номер в страховую': 'Nv_ins',
        '№ акта осмотра ТС': 'Na_ins',
        'Дата акта осмотра ТС': 'date_Na_ins',
        'Адрес своего СТО для дополнительного осмотра': 'address_sto_main',
        'Дата записи в свое СТО для дополнительного осмотра': 'data_sto_main',
        'Время записи в свое СТО для дополнительного осмотра': 'time_sto_main',
        'Дата Составления претензии': 'date_pret',
        'Стоимость услуг нотариуса число': 'coin_not',
        'Номер доверенности': 'N_dov_not',
        'Дата доверенности': 'data_dov_not',
        'Представитель по доверенности': 'fio_not',
        'Телефон представителя': 'number_not',
        'Дата экспертного заключения': 'date_exp',
        'Организация, сделавшая экспертизу': 'org_exp',
        'Выплата по ОСАГО': 'coin_osago',
        'Цена по экспертизе без учета износа': 'coin_exp',
        'Цена по экспертизе с учетом износа': 'coin_exp_izn',
        'Номер направления на ремонт': 'N_sto',
        'Дата направления на ремонт': 'date_napr_sto',
        'Название СТО': 'name_sto',
        'Индекс СТО': 'index_sto',
        'Адрес СТО': 'address_sto',
        'Город СТО': 'city_sto',
        'ИНН Компании СТО': 'inn_sto',
        'Дата передачи авто на СТО': 'date_sto',
        'Дата отказа СТО': 'data_otkaz_sto',
        'Дата составления заявления омбуцмену': 'date_ombuc',
        'Дата ответа на претензию': 'data_pret_otv',
        'Дата искового заявления': 'date_isk',
        'Суд': 'sud',
        'Стоимость государственной пошлины': 'gos_money',
        'Дата извещения о ДТП': 'date_izvesh_dtp',
        'Улица': 'street',
        'Номер определения ГАИ': 'N_gui',
        'Дата определения ГАИ': 'date_gui',
        'Номер протокола об административном правонарушении': 'N_prot',
        'Дата протокола об административном правонарушении': 'date_prot',
        'Дата обследования дорожного покрытия': 'date_road',
        'Номер квитанции оплаты нотариуса': 'N_kv_not',
        'Дата квитанции оплаты нотариуса': 'date_kv_not',
        'Номер чека оплаты юр услуг': 'N_kv_ur',
        'Дата чека оплаты юр услуг': 'date_kv_ur',
        'Номер квитанции экспертизы': 'N_kv_exp'
    }
